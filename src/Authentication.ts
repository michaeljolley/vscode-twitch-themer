...
export class AuthenticationService {
    ...
    public async initialize() {
        if (keytar) {
            ...
            const userId = await keytar.getPassword(KeytarKeys.service, KeytarKeys.userId);
            ...
            if (mReqPath === '/') {
                ...
                if (keytar) {
                    if (q.state === state) {
                        ...
                        keytar.setPassword(KeytarKeys.service, KeytarKeys.userId, authUser.id);
                        keytar.setPassword(KeytarKeys.service, KeytarKeys.userLogin, authUser.login);
                        this.authStatusEventEmitter.fire(true);
                    } else {
